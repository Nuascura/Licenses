...
; Mod Quests
Quest Property kzadLibs auto hidden
Quest Property kzadDeviceLists auto hidden
...
Function CheckSoftDependencies(BM_Licenses_MCM bmlmcm)
	...
	&& (Game.GetModByName("Devious Devices - Contraptions.esm") != 255)
        ...
        kzadLibs = Game.GetFormFromFile(0x00F624, "Devious Devices - Integration.esm") as Quest
        kzadDeviceLists = Game.GetFormFromFile(0x00CA01, "Devious Devices - Expansion.esm") as Quest
